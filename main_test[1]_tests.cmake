...
add_test([=[CoordinateTest.properties]=]  /Users/danielsilva/Documents/Docker/docker-gcc/build/main_test [==[--gtest_filter=CoordinateTest.properties]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CoordinateTest.properties]=]  PROPERTIES WORKING_DIRECTORY /Users/danielsilva/Documents/Docker/docker-gcc SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CoordinateTest.sumCoordinates]=]  /Users/danielsilva/Documents/Docker/docker-gcc/build/main_test [==[--gtest_filter=CoordinateTest.sumCoordinates]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CoordinateTest.sumCoordinates]=]  PROPERTIES WORKING_DIRECTORY /Users/danielsilva/Documents/Docker/docker-gcc SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
set(  main_test_TESTS HelloGTEST.first HelloGTEST.second HelloGTEST.third CoordinateTest.properties CoordinateTest.sumCoordinates)
